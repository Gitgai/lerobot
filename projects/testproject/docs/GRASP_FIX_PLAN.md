...
**GPU-served, closed-loop inference.** Same idea as the Pi05 policy-server setup. Fixes correctness _and_ speed at once:
...
| Grasp     | closes on schedule → air | closes when it _sees_ it's on the orange |
...
- **Success:** gripper closes _while down at the orange_; ≥1 clean pick.
