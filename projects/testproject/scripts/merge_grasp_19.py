...
for k, ds in zip(SRC, dss): print(f"{k}: {ds.meta.total_episodes} eps, {ds.num_frames} frames")
OUT = "/data/lerobot_datasets/so101_orange_grasp19"
m = merge_datasets(dss, output_repo_id="local/so101_orange_grasp19", output_dir=OUT)
