...
# First real cleaned-dataset Pi05 fine-tune.
# This starts from zz4321/so101_pi05 and trains on our cleaned orange-move
# demonstrations. It uses expert-only training first to fit an A40-class GPU.
...
OUTPUT_DIR="${OUTPUT_DIR:-/workspace/outputs/pi05_so101_orange_move_action_start_view_expert}"
JOB_NAME="${JOB_NAME:-pi05_so101_orange_move_action_start_view_expert}"
POLICY_REPO_ID="${POLICY_REPO_ID:-local/pi05_so101_orange_move_action_start_view_expert}"
STEPS="${STEPS:-3000}"
...
echo "PI05 CLEANED DATASET EXPERT-ONLY FINE-TUNE"
