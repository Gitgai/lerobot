...
# Smoke test for direct fine-tuning from lerobot/pi05_base on the 49-episode
# SO-101 orange dataset. This proves the environment, dataset, base download,
# feature schema, and checkpoint writing before a longer GPU run.
...
OUTPUT_DIR="${OUTPUT_DIR:-/workspace/outputs/pi05_base_to_orange49_smoke}"
JOB_NAME="${JOB_NAME:-pi05_base_to_orange49_smoke}"
POLICY_REPO_ID="${POLICY_REPO_ID:-local/pi05_base_to_orange49_smoke}"
STEPS="${STEPS:-200}"
...
echo "PI05 BASE -> ORANGE49 SMOKE TRAIN"
...
echo "PI05_BASE_ORANGE49_SMOKE_OK"
